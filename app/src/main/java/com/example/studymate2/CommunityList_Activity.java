...
public class CommunityList_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_commuity);


        recyclerView = (RecyclerView) findViewById(R.id.rc_community); //  아이디 연결
        ...
        databaseReference = database.getReference("Community"); //DB 테이블 연결
