...
public class ScianceList_Activity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activirty_sciance);



            recyclerView = (RecyclerView) findViewById(R.id.rc_sciance); //  아이디 연결
            ...
            databaseReference = database.getReference("Sciance"); //DB 테이블 연결
